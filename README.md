...
- Kopieren in `Hex`, `RGB(A)`, `HSL(A)`, `LCH`
...
- Persistente Liste eigener Farben (20 Slots)
...
## Persistence
Eigene Farben werden als JSON in `UserDefaults` gespeichert. Die UI zeigt feste Platzhalter, sobald weniger als 20 Farben vorhanden sind.
